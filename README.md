...
**H6 is closed** (Decision Log 2026-09-12). Current work is the M4a remainder (E10 is the M4a blocker). Pinned: O4 (2026-09-12), Stage 2/3, H10 open (leftovers implemented, not closed), M3b remainder. All formats remain draft-1 and unfrozen. Do not claim M4a complete, M3b exit, format freeze, or retag `v0.1.0`.
