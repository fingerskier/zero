...
**Not** in this slice: AUTH membership grants and encrypted payload enforcement (rest of M3b). Signature / OpId / datastore admission is on (`m3b_admission`). Full 1,000-write E3 is exercised in `zerodb-storage/tests/relay_client.rs`.
