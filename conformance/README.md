...
└── ts/
    ...
    └── webrtc/      # H6 closed (protocol): SIGNAL fanout + PeerId roles +
                     #   DataChannel peer protocol + reconnect/admission +
                     #   HELLO.datastore in AUTH. Named fixtures: vectors/required/h6/.
                     #   Not M4a complete.
```
