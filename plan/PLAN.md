...
12. **H6 Decision Log close (this PR)** — **H6 closed.** Shared peer protocol over DataChannel ([RELAY-SPEC](../doc/RELAY-SPEC.md) §14.2). Evidence #25–#28. TURN/NAT parked as infra (no hosted TURN / `wrtc`). **Not** M4a complete. O4 still open. No E10.
